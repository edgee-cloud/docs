...
<Note>
  Google Analytics integration accepts `page`, `identify`, and `track` events.
</Note>
...
<Warning>
  ...
  Edgee monitors the capabilities of the Measurement Protocol API and regularly updates the GA integration to propose the best level of reporting.
</Warning>
