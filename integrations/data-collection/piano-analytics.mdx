...
<Note>
  Piano Analytics integration accepts `page`, `identify`, and `track` events.
</Note>
...
3. Input your Piano Analytics `Site ID` and `API Key`, then click Save to finalize the integration. <br />
...
4. Once integrated, you're all set to start forwarding analytics events to Piano Analytics directly from the edge.
