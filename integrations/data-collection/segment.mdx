...
and analytics seamlessly at the edge. This integration eliminates the need to embed Segment's script directly on your website, 
significantly improving site performance and adhering to strict privacy standards.

<Note>
  Segment integration accepts `page`, `identify`, and `track` events.
</Note>
...
4. Select "Add Destination" and pick "Segment" from the list of available analytics integrations.
5. With this setup, you're ready to transmit events directly to Segment, leveraging the edge's power for your analytics.

## Destination Name

When configuring your **Context Payload** or making SDK calls, use "Segment" as the destination name to ensure your data is correctly routed.
