...
<CardGroup cols={2}>
  ...
  <Card title="Routing & reliability" icon="route" iconType="duotone" href="/features/automatic-model-selection">
    Policy-based routing, fallbacks, and safer failure modes when providers rate-limit or degrade.
  </Card>

  <Card title="Observability & cost" icon="chart-line" iconType="duotone" href="/features/observability">
