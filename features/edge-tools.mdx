...
<Note>
Edge Tools are in progress. We're building the tool runtime and permissions model. If your agent or tool stack has clear requirements, we can align the first release to them.
</Note>
