...
<Columns cols={2}>
  ...
  <div className="block dark:hidden">
    <Card title="Piano Analytics Gateway" href="/components/js-gateway/piano-analytics-gateway" horizontal={true} icon="/images/logos/piano-analytics.svg" />
  </div>
  <div className="hidden dark:block">
    <Card title="Piano Analytics Gateway" href="/components/js-gateway/piano-analytics-gateway" horizontal={true} icon="/images/logos/piano-analytics-dark.svg" />
  </div>
  {/* Server Side Tagging */}
  <Card title="Google Tag Gateway" href="/components/js-gateway/google-tag-gateway" horizontal={true} icon="/images/logos/gtm.svg" />
  <Card title="Meta Signals Gateway" href="/components/js-gateway/meta-signals-gateway" horizontal={true} icon="/images/logos/meta.svg" />
</Columns>