...
<CardGroup cols={2}>
<Card title="DataDome Bot Protection" href="/proxy/components/security/datadome" icon="shield-check">
  Advanced bot detection and fraud protection using machine learning to complement IP-based blocking.
</Card>

<Card title="Rate Limiting" href="/proxy/services/security/rate-limiting" icon="gauge-high">
  Control request rates and prevent abuse with built-in rate limiting capabilities.
</Card>

<Card title="Access Control" href="/proxy/services/security/access-control" icon="key">
