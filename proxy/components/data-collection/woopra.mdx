...
<img src="/images/banners/woopra.png" className="rounded-lg" noZoom />

Find it on GitHub: [<Icon icon="github" iconType="solid" /> /edgee-ai/woopra-component](https://github.com/edgee-ai/woopra-component)
