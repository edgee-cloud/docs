...
<img src="/images/banners/aws-firehose.png" className="rounded-lg" noZoom />


Find it on GitHub: [<Icon icon="github" iconType="solid" /> /edgee-ai/amazon-data-firehose-component](https://github.com/edgee-ai/amazon-data-firehose-component)
...
2. Select "Add a component" and choose `edgee/amazon-firehose` from the list of available components.
