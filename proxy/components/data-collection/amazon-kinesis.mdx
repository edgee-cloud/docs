...
<img src="/images/banners/aws-kinesis.png" className="rounded-lg" noZoom />


Find it on GitHub: [<Icon icon="github" iconType="solid" /> /edgee-ai/amazon-kinesis-component](https://github.com/edgee-ai/amazon-kinesis-component)
...
2. Select "Add a component" and choose `edgee/amazon-kinesis` from the list of available components.
