...
Find it on GitHub: [<Icon icon="github" iconType="solid" /> /edgee-ai/linkedin-capi-component](https://github.com/edgee-ai/linkedin-capi-component)
...
3. Go to your Edgee account and project, then navigate to **Components** (learn to set up components [here](https://www.edgee.ai/docs/proxy/getting-started/component-configuration)). Select LinkedIn and input your token.  
