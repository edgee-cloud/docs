...
<CardGroup>
  ...
  <Card title="Edgee React Component" icon="react" href="/proxy/getting-started/react-sdk">
  ...
  <Card title="Mobile SDKs" icon="mobile" href="/proxy/getting-started/mobile-sdk">
