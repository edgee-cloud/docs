...
Congratulations! Your edge function component is now available on the Edgee Component Registry at `https://www.edgee.ai/{organization}/{component}`.
...
First of all, you'll need to [create a project](/proxy/getting-started/project-settings) and configure it for your website.
