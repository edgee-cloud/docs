...
[Google Analytics](/proxy/components/data-collection/google-analytics) or [Amplitude](/proxy/components/data-collection/amplitude),
for attribution/conversion such as
[Meta Conversions API](/proxy/components/data-collection/meta-capi) or [LinkedIn Conversions API](/proxy/components/data-collection/linkedin-capi),
and for data streaming and warehousing destinations such as
[Amazon S3](/proxy/components/data-collection/amazon-data-firehose),
[Amazon Kinesis](/proxy/components/data-collection/amazon-kinesis),
or [Amazon Data Firehose](/proxy/components/data-collection/amazon-data-firehose).
...
a definition language to define types and worlds. You can find [Edgee's WIT files on GitHub](https://github.com/edgee-ai/edgee-wit).
...
#### Edgee CLI and APIs
The [Edgee CLI](https://github.com/edgee-ai/cli) lets you create and build Wasm components locally with commands such as
