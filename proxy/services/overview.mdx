...
For detailed information about our privacy practices and compliance framework, please refer to our [Privacy Documentation](/proxy/privacy).
...
[Learn more about Component Registry](/proxy/services/registry/overview)
...
[Learn more about Consent Management](/proxy/services/consent/overview)
...
[Learn more about Data Collection](/proxy/services/data-collection/overview)
...
[Learn more about Security services](/proxy/services/security)


### Stitching

Stitching enables advanced A/B testing and feature experimentation by serving experimentation platform resources as first-party assets from your domain. This approach eliminates adblock interference while improving performance through edge-cached configurations.

- **First-Party Serving**: All experimentation scripts and API calls are served from your domain, avoiding third-party blocking
- **Edge-Cached Configurations**: Experiment settings are cached at edge locations for instant access, eliminating client-side configuration fetching delays
- **Zero Flicker Potential**: Faster resource loading and configuration access reduces visual flicker in experiments
- **Enhanced Test Accuracy**: Higher participation rates due to reduced resource blocking by privacy tools

[Learn more about Stitching services](/proxy/services/stitching/overview)
