...
The way you insert a **Data Layer** in your application depends on the [Edgee SDK](/proxy/getting-started/sdk) you're using.
...
Learn more about the [page](/proxy/services/data-collection/page-event), [track](/proxy/services/data-collection/track-event),
and [user](/proxy/services/data-collection/user-event) event types and their structure.
