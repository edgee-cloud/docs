...
These components are only available for [Google Analytics](/proxy/components/identity/google-analytics-native-cookies), [Amplitude](/proxy/components/identity/amplitude-native-cookies) and [Piano Analytics](/proxy/components/identity/piano-analytics-native-cookies) for now.
...
<Frame caption="Go to your project > Components > Your component, then configure the Native Cookies mode">
...
- **[Amplitude](/proxy/components/identity/amplitude-native-cookies)**: Manages the `AMP_[API_KEY]` device ID cookie
- **[Google Analytics](/proxy/components/identity/google-analytics-native-cookies)**: Manages the `_ga` client ID cookie
- **[Piano Analytics](/proxy/components/identity/piano-analytics-native-cookies)**: Manages various cookies based on configuration (`atid`, `_pcid`, `atuserid`)
