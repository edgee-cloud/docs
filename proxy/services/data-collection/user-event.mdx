...
In addition to that, some components support the user event natively, such as [Amplitude](/proxy/components/data-collection/amplitude) and [Segment](/proxy/components/data-collection/segment).
