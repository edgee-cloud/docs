...
<CardGroup cols={2}>
  ...
  <Card title="Cost & Observability" icon="chart-line" iconType="duotone" href="/feature/observability">
    Real-time cost tracking, latency metrics, and request logs. 
    Know exactly what your AI is doing and costing.
  </Card>

  <Card title="Privacy-First Design" icon="shield" iconType="duotone" href="/feature/privacy">
    Control how your data flows. Enable provider-side ZDR, 
    configure logging policies, and add privacy layers to your prompts.
  </Card>
</CardGroup>
