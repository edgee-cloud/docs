...
Because you want HTTP requests to reach Edgee for data collection, you'll need to disable caching in the existing CDN. 
Then, to get the full benefits of Edgee's performance, you might want to [enable caching on Edgee](/getting-started/caching).
...
For example, you can disable it for Google Analytics as follows:
...
Let's look at an example. If you're using Google Analytics, you'll convert this:
...
[Learn more about how to collect the identify event](/services/data-collection/identify-event).
