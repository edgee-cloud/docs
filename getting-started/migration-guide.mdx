...
2. Set up Edgee to [route traffic to your domain](/getting-started/routing).
3. Make sure the **cookie domain** and **frontend hostname** are both set to your custom domain name.
4. Add [required secret headers](services/security/access-control#required-header) for your CDN to verify that requests originate from the Edgee proxy
