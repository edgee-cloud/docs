...
description: Learn how to integrate our SDK to interact with your Edgee services.
---

Adding our SDK to your application is required to get Edgee up and running. It only takes a few minutes.
...
We provide SDKs for different frameworks and libraries. Choose the one that fits your project:

<CardGroup>
  <Card title="Integrate Edgee JS SDK" icon="js" href="/getting-started/js-sdk">
    Add the JavaScript SDK to your HTML document to get Edgee up and running.
  </Card>

  <Card title="Integrate Edgee React Component" icon="react" href="/getting-started/react-sdk">
    Use the React component to inject the Edgee SDK script into a React application.
  </Card>
</CardGroup>
