---
title: ReactJS SDK
description: Integrate the Edgee SDK in a React SPA.
icon: react
---

For applications built with React, we provide a dedicated library to simplify the integration of our SDK. 
This library ensures that Edgee's services are seamlessly integrated and that page views are tracked accurately during SPA navigations.
...
For more details about using the Edgee SDK, visit the [React-Edgee repository](https://github.com/edgee-cloud/react-edgee).
...
AB testing, security measures, and more, ensuring your web application not only performs efficiently but also delivers a superior user experience.
