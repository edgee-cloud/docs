...
The Edgee platform allows you to organize your projects into **organizations**.
This is useful for managing multiple projects, especially if you are working with different teams or clients.

You can create multiple organizations and assign different users to each organization.
...
Additionally, it simplifies billing across multiple organizations as all consumption
is billed to the main organization.
...
<Note>
    Note: the new sub-organization will be created under the currently selected organization.
    You can change the selected organization by clicking on the organization name in the top-left menu.
