...
Use this setup when you only need Edgee in front of Vercel for performance or security, and SEO isn’t a concern.
...
3. Create a new route:
   - **Origin URL** → your Vercel project domain from Step 1
   - **Host Override** → set this to your custom domain (e.g. `www.mywebsite.com`)
   - **SNI** → leave this as your Vercel domain  
   - **Cert Hostname** → must match your Vercel domain  
4. Save the routing configuration.
