---
title: PrestaShop
description: Enable PrestaShop to correctly read client IPs from Edgee’s forwarded headers.
icon: stairs
---
...
When Edgee sits in front of PrestaShop, it proxies all traffic, causing PrestaShop to record **Edgee’s Cloud IP** instead of the **actual client IP**, which can lead to account access problems.
...
1. Contact the Edgee team at [support@edgee.com](mailto:support@edgee.com) to request the PrestaShop module.
