...
description: "Understand and analyze AI bot traffic on your website with Edgee's comprehensive analytics platform."
---
...
Edgee's AI Analytics helps you understand how AI bots and Large Language Model (LLM) crawlers interact with your website. Gain insights into which AI services are accessing your content, how frequently they visit, and what impact this traffic has on your infrastructure.

## Key Features

### AI Bot Detection & Classification
- **Bot Identification**: Automatically detect and classify AI/LLM bots from your web traffic
- **Service Recognition**: Identify specific AI services (OpenAI, Anthropic, Google AI, etc.)
- **Traffic Patterns**: Understand when and how often AI bots visit your site

### Traffic Analytics
- **Volume Tracking**: Monitor the volume of AI bot traffic over time
- **Content Analysis**: See which pages and content AI bots access most
- **Bandwidth Impact**: Understand the infrastructure cost of AI bot traffic

### Advanced Insights
- **Crawling Behavior**: Analyze how different AI bots navigate your site
- **Content Preferences**: Identify what type of content attracts AI crawlers
- **Traffic Impact**: Understand the volume and patterns of AI bot visits

## How It Works

```mermaid
graph LR
    A[AI Bots Visit Website] --> B[Access Logs Generated]
    B --> C[Log Ingestion to Edgee]
    C --> D[AI Bot Detection Engine]
    D --> E[Analytics Dashboard]
    D --> F[Traffic Reports]
    D --> G[Bot Insights]
```

1. **Log Collection**: Your web server generates access logs from all traffic including AI bots
...
### Content Strategy
Understand AI bot preferences to:
...
- Competitive analysis of AI bot activity
