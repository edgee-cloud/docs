...
If you followed the [Data Collection Highlights](/services/data-collection/overview), you've already installed the Edgee SDK on your website.
...
whenever a user navigates to a new part of the application. Here’s an example of how to manually trigger a `page` event:
...
But to avoid having to change the **Context Payload** every time you manually call `edgee.page()`, you can specify the fields directly in the method,
