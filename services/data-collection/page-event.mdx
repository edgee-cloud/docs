...
To know more about the **Context Payload** capabilities, and how to use it with React, 
check the [dedicated documentation](/services/data-collection/context-payload).
