...
If you followed the [Data Collection Highlights](/services/data-collection/overview), you've already installed the [Edgee SDK](/getting-started/sdk) on your website.
...
You can manually specify each field by writing what we call a JSON **Context Payload** in your page.
...
In case you don't specify a Context Payload, here's how Edgee gathers the page information:
