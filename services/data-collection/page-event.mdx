...
When processing `page` event data for analytics integration, Edgee implements robust data anonymization techniques. These methods 
...
With anonymization, we guarantee that default `page` data sent to your analytics integrations cannot be used to identify and track an individual.
