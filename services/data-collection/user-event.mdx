...
field |    | type | description
--- | -- |--- | ---
`userObj` | _optional_ | object\|String | A free-form dictionary object containing details of the `user` event. This object can include all the following optional fields: `user_id`, `anonymoudId`, and `properties`. You can also provide a string that will be used as the `user_id` field.
