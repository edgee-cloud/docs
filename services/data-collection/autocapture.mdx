...
<Note>
Click tracking respects the `data-edgee-no-autocapture` attribute. Any element with this attribute or any of its parents will be excluded from click tracking.
</Note>
