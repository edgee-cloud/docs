...
and for data warehousing destinations such as
...
<Note>
    Note: starting from `v0.9.0`, the Edgee CLI is taking care of managing and updating WIT dependencies automatically for you, under
    a hidden `.edgee/wit` folder. You shouldn't need to worry about WIT files or dependencies at all.

    When a new WIT release is available, you only need to update the WIT version in your the component's manifest.
</Note>

#### Edgee CLI and APIs
You can use the [Edgee CLI](https://github.com/edgee-cloud/edgee) to create and build Wasm components locally with commands such as
