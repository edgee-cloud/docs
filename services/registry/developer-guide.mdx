...
- `[component]`: here you define what your component is all about, including its public name and latest version
  ...
  - `wit-version`: the WIT version of the interface implemented by this component (will be `1.0.0` at launch).
  When a new WIT version is available
...
<Warning>
  ...
  5. Edit your `edgee-component.toml` file update the `wit-version` field to `0.5.0`
...
Visit the **Data Collection** section of your project and click **Add a component**. Here you can filter by category,
