---
title: Data Collection Developer Guide
description: Step-by-step guide for data collection component developers
icon: database
---
...
$ edgee components new --name my-component --language rust --type data-collection
 INFO Downloading sample code for Rust...
 INFO Extracting code...
 INFO Downloading WIT files...
 INFO New project my-component is ready! Check README for dependencies.
