...
Cache rules allow you to define how requests are cached based on their path, and request and response headers. 
...
- **Erase Set-Cookie**: Remove of Keep Set-Cookie headers from cached responses
