...
<Warning>
    ...
    A few breaking changes might happen in the next few weeks, please consider this unstable and share your feedback in the
    appropriate channels if you think you found a bug or security vulnerability.
</Warning>
...
You can view and edit it at: https://edgee.cloud/~/{organization}/component-registry/{organization}/{component}
```
...
In case you pushed a private component, you can view and edit it at `https://edgee.cloud/~/{organization}/component-registry/`.
...
<Warning>
  ...
  TODO: add proxy documentation link
</Warning>
