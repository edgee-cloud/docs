...
2. Select "Add a component" and choose `mailchimp` from the list of available edge functions.
...
- **API Key Encryption**: Your Mailchimp API key is stored securely
...
For more details on Mailchimp's API, refer to the 
[official Mailchimp API documentation](https://mailchimp.com/developer/marketing/api/).