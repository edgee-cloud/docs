...
3. Input your Piano Analytics `Site ID` and `Collection Domain`, then click Save. <br />
_(Your Site ID and Collection Domain are available within your [Piano Analytics dashboard](https://analytics.piano.io/datacollection/#/dashboard), 
under the project settings or API configuration section.)_
