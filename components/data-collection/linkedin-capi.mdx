...
1. Set up your test events in LinkedIn Events Manager
2. Add your test event code to the component configuration
3. Send test events through Edgee
4. Verify events in LinkedIn Events Manager's Test Events tab

<Note>
  Use LinkedIn's Test Event Code during implementation to avoid affecting your actual data and ad campaigns.
</Note>
