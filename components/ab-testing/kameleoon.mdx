...
The Kameleoon component proxifies both the Kameleoon SDK and the Web Experiment Engine.
This means these scripts are always served from your website's domain instead of Kameleoon's servers.
