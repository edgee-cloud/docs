...
<Step title="Configure component settings">
  ...
  - **Endpoint URL**: `https://admin.api.crowdsec.net/v1/integrations/{YOUR_INTEGRATION_ID}/content`
...
<Step title="Test and activate">
  ...
  2. Monitor your Edgee logs to verify the component is fetching blocklists
  3. Check CrowdSec Console for integration activity
</Step>
</Steps>
...
- **Credential Security**: Store API credentials securely and rotate them periodically  
