---
title: "Errors"
description: "How Assembly API responds when errors occur."
---

Assembly uses conventional HTTP response codes to indicate the success or failure of an API request. 
...
Codes in the 5xx range indicate an error with Assembly's servers.
...
Bellow is a summary of the HTTP status codes that Assembly API uses.
